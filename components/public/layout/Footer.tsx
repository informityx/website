          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            {footerAboutVisible && (
              <div>
                ...
                <p className="text-white/90 text-sm whitespace-pre-line text-justify pr-6">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  {customTypesInFooter.map((ct) => (
                    <li key={ct.slug} className="space-y-1">
                      <Link
                        href={`/${ct.slug}`}
                        className="text-white/90 hover:text-brand-hover text-sm transition-colors font-medium"
                      >
                        {ct.name}
                      </Link>
                    </li>
                  ...
                  {footerSocialJson?.twitter?.url && (
                    <li>
                      ...
                      >
                        ...
                        <span>{footerSocialJson.twitter.text || "X"}</span>
                      </a>
                    </li>
                  )}
